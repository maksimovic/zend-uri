...
class Zend_Uri_HttpTest extends TestCase
{
     ...
     */
    public function testSimpleFromString(): void
    {
        $tests = array(
            'http://www.zend.com',
            'https://www.zend.com',
     ...
     * a string.
     */
    public function testFromStringWithInvalidVariableType(): void
    {
        $this->expectException(Zend_Uri_Exception::class);
    ...
    public function testUsernamePassword(): void
    {
        $this->_testValidUri('http://andi:password@www.zend.com');
    }

    public function testUsernamePasswordColon(): void
    {
        $this->_testValidUri('http://an:di:password@www.zend.com');
    }

    public function testUsernamePasswordValidCharacters(): void
    {
        $this->_testValidUri('http://a_.!~*\'(-)n0123Di%25%26:pass;:&=+$,word@www.zend.com');
    }

    public function testUsernameInvalidCharacter(): void
    {
        $this->_testInvalidUri('http://an`di:password@www.zend.com');
    }

    public function testNoUsernamePassword(): void
    {
        $this->_testInvalidUri('http://:password@www.zend.com');
    }

    public function testPasswordInvalidCharacter(): void
    {
        $this->_testInvalidUri('http://andi:pass%word@www.zend.com');
    }

    public function testMissingDomainParts(): void
    {
        $this->_testInvalidUri('https://www.zend..com');
    }

    public function testHostAsIP(): void
    {
    ...
    public function testLocalhostLocaldomain(): void
    {
     ...
     * @group ZF-1934
     */
    public function testUnencodedQueryParameters(): void
    {
     ...
     */
    public function testExceptionUnwiseQueryString(): void
    {
        $unwise = array(
            'http://example.com/?q={',
            'http://example.com/?q=}',
     ...
     * accepted
     */
    public function testAllowUnwiseQueryString(): void
    {
        $unwise = array(
            'http://example.com/?q={',
            'http://example.com/?q=}',
     ...
     * @group ZF-7840
     */
    public function testVeryLongUriZF3712(): void
    {
        ...
        $uri = file_get_contents(__DIR__ . DIRECTORY_SEPARATOR .
     ...
     * @param string $uri
     */
    protected function _testValidUri($uri): void
    {
     ...
     * @param string $uri
     */
    protected function _testInvalidUri($uri): void
    {
        try {
            $obj = Zend_Uri::factory($uri);
    ...
    public function testUriWithAllParts(): void
    {
    ...
    public function testBuildCompleteUriFromScratch(): void
    {
    ...
    public function testSetInvalidUsername(): void
    {
        $uri = Zend_Uri::factory('http://example.com');
        $this->expectException(Zend_Uri_Exception::class);
        $uri->setUsername('alice?');
    ...
    public function testSetEmptyHost(): void
    {
        $uri = Zend_Uri::factory('http://example.com');
        $host = '';
        $this->expectException(Zend_Uri_Exception::class);
     ...
     * @group ZF-1480
     */
    public function testGetQueryAsArrayReturnsCorrectArray(): void
    {
     ...
     * @group ZF-1480
     */
    public function testAddReplaceQueryParametersModifiesQueryAndReturnsOldQuery(): void
    {
     ...
     * @group ZF-1480
     */
    public function testRemoveQueryParametersModifiesQueryAndReturnsOldQuery(): void
    {
     ...
     */
    public function testParserSupportsLiteralIpv6AddressesInUri(): void
    {
